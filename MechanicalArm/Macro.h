...
#define MESSAGE_CERR(_TYPE_,_INFO_) \
	std::cerr << "[" << _TYPE_ << "]\t" << _INFO_ << std::endl

#define MESSAGE_INFO(_INFO_) MESSAGE_COUT("INFO", _INFO_)
#define MESSAGE_ERROR(_INFO_) MESSAGE_COUT("ERROR", _INFO_)
